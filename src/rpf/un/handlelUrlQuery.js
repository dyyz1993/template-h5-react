 ...
 * // 假设页面为 https://new2.baidu.com/?a=1&b=2
 * getUrlQuery(); // { a: '1', b: '2' }
 * getUrlQuery('a'); // 1
 * getUrlQuery('c'); // ''
 * ```
 ...
 * // 假设页面为 https://new2.baidu.com/?a=1&b=2&c=3
 * delUrlQuery(['a', 'c']); // https://new2.baidu.com/?b=2
 * ```
 ...
 * // 假设页面为 https://new2.baidu.com/?a=1&b=2
 * changeUrlQuery(window.location.href, 'a', 'updateA'); // https://new2.baidu.com/?b=2&a=UpdateA
 * changeUrlQuery(window.location.href, 'c', '3'); // https://new2.baidu.com/?a=1&b=2&c=3
 * ```
 *
